...
#define TIM2_overflow_1024us()   TCCR2B &= ~((1<<CS20) | (1<<CS21));				TCCR2B |= (1<<CS22);
#define TIM2_overflow_2048us()   TCCR2B &= ~(1<<CS21) ;								TCCR2B |= ((1<<CS22) | (1<<CS20));
#define TIM2_overflow_4096us()   TCCR2B &= ~(1<<CS20) ;								TCCR2B |= ((1<<CS22) | (1<<CS21));
#define TIM2_overflow_16384us()  TCCR2B |= ((1<<CS22) | (1<<CS20) | (1<<CS21));
